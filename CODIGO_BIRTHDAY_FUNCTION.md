# 📋 CÓDIGO COMPLETO - auto-birthday-messages

**Copie e cole este código inteiro no editor da Edge Function**
        ...
        for (const salon of salons) {
            ...
            for (const client of birthdayClients) {
                ...
                const message = template.message(
                    client.name,
                    salon.name,
                    salon.birthday_discount_percent || 10
                );
...
3. Nome: `auto-birthday-messages`
4. **DELETE TODO O CÓDIGO** padrão
