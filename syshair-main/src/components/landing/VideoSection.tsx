...
// ============================================
// Para adicionar seu vídeo do YouTube:
// 1. Pegue o ID do vídeo (ex: https://www.youtube.com/watch?v=ABC123 -> ID é "ABC123")
// 2. Substitua "dQw4w9WgXcQ" pelo seu ID abaixo
// ============================================
const VIDEO_CONFIG = {
    youtubeId: "dQw4w9WgXcQ", // TODO: Substitua pelo ID do seu vídeo
    title: "Tour completo pelo sistema",
    duration: "2 minutos",
    thumbnailUrl: "https://images.unsplash.com/photo-1560066984-138dadb4c035?w=1200&h=675&fit=crop",
};
                        ...
                        {!isPlaying ? (
                            <div className="relative aspect-video group cursor-pointer" onClick={() => setIsPlaying(true)}>
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-6">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <p className="text-white font-semibold text-lg">{VIDEO_CONFIG.title}</p>
                                            <p className="text-white/70 text-sm">{VIDEO_CONFIG.duration} • HD</p>
                                        </div>
                            ...
                            <div className="relative aspect-video bg-black">
                                ...
                                <iframe
                                    ...
                                    src={`https://www.youtube.com/embed/${VIDEO_CONFIG.youtubeId}?autoplay=1`}
                                    title="SysHair Demo"
                                    frameBorder="0"
